    ...
    <div className="mx-auto max-w-5xl px-4 pt-24 pb-20 sm:px-6 lg:px-8">
      ...
      {filteredOrders.length === 0 ? (
        <div className="flex h-[50vh] flex-col items-center justify-center gap-4 text-center">
          ...
          <div>
            <p className="font-display text-2xl font-semibold">No orders found</p>
                ...
                >
                  ...
                  <div className="divide-y divide-border">
                    {order.items.map((item, j) => (
                      <div key={j} className="flex items-center gap-4 p-5">
                        <img
                  ...
                  <div className="border-t border-border p-5">
                    <div className="flex items-center justify-between">
                      {['Processing', 'Shipped', 'Delivered'].map((step, k) => {
                            ...
                            <div className="flex w-full items-center">
                              {k > 0 && (
                                <div
                                  className={cn(
                                    'h-[2px] flex-1',
                                    k <= stepIndex ? 'bg-foreground' : 'bg-border'
                                  )}
                                />
                              )}
                              <div
